layui.use("layer", function () {
    ...
    function initJobTopTen(jobs) {
        ...
        jobs.forEach(function (job, index) {
            ...
            xAxis[index]={value:job.jobId+"("+job.jobName+")",textStyle:{
                    fontSize:8
                }}
        })
...
function getStopHeraJobInfo() {
    let url = base_url + "/scheduleCenter/getStopHeraJobInfo.do";
...
function getSqoopFailedNum() {
    let url = base_url + "/sqoopTaskCenter/getSqoopFailedNum.do";
    $.get(url, function (data) {
...
function getFindNum() {
    ...
    　　*/
    let url = base_url + "/homePage/getDataFindNum";
    let parameter;
