...
<header class="main-header">
    <a href="${request.contextPath}/home" class="logo">
        <span class="logo-mini"><b>盈亚科技</b></span>
    ...
    <section class="sidebar">
        ...
        <#--</li>-->
                ...
                &lt;#&ndash;<a href="${request.contextPath}/datalinkMintor">&ndash;&gt;
                    ...
                    <li class="nav-click" id="maxwellInfo">
                        <a href="${request.contextPath}/maxwellInfo">
                            <i class="fa fa-book"></i> maxwell监控</a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" treeview menu-closed my-tree" id="bigdataMetadata">
                ...
                <ul class="treeview-menu">
                    <li class="" id="dataDictionary"><a href="${request.contextPath}/bigdataMetadata/dataDictionary"><i
                            class="fa fa-circle-o"></i>数据字典</a>
                    </li>
                    <li class="" id="metadataMonitor">
                        <a href="${request.contextPath}/bigdataMetadata/metadataMonitor"><i
            ...
            <li class="nav-click" id="scheduleManage"><a
                    href="${request.contextPath}/scheduleCenter?syFlag=0"><i class="fa fa-edit"></i> <span>调度中心</span></a>
            </li>
        <#--<li class="nav-click" id="scheduleManage"><a
...
<footer class="main-footer">
    Powered by <b>hera</b> 2.3.1（快照版本）
